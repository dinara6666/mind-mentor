export const mentors = [
    ...
    {
      id: 3,
      img: 'https://s3-alpha-sig.figma.com/img/da64/410b/7c9181268cef3db500727afa985f46a1?Expires=1744588800&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=L5WBUInVS-L~zAsx99jYSbggxdN8g7mWfoQwD~M~9h5elRWucco6EwaGA6dekHkWMRxmwWCGrZGmjxtggyWPSc2Os~PY25FEcD0QzrwZnFcV849D57hbLu658MIhGi6EgsjH7O-e457MtM-s6ntPDTWBEcvW9aX6y~~Rv7~ivtZ3anteVM0iwKpTMC0ftisYXut6evY6UEPREnB~TuzQpSoJRPoeH1u8b8fOcJof8ESqFaOLc2gyEdoqw0cx~bXuyRMHXRg3TeFKABxG2-xEXAAaDOJd63L02GNCQt5oId803Qi0~0k9tH6ayTrvncq7laYyl8hy4GRQ-grGfRYboA__',
      name: 'Марина Сополова',
      students: 1200,
      language: 'Русский',
      experience: '3 года',
    ...
    //   experience: '3 года',
    //   company: 'Google',
    //   specialty: 'Специалисть Senior UX/UI дизайнер ',
    //   description: 'Вы узнаете в этом курсы,как создавать сайты с нуля.Научитесь работать програмами как Figma,Affter Effect',
    //   price: 2000
    // },
  ];